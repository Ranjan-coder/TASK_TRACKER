...
const InputData = ({inputdiv,setInputdiv,updatedData,setUpdatedData}) => {
  ...
  const submitData = async()=>{
    if(Data.title === "" || Data.desc === ""){
      ...
      await axios.post('https://task-tracker-rkkb.onrender.com/api/task/createtask',Data,{headers})
      setData({title:"",desc:""})
      setInputdiv("hidden")
    }
  }
  ...
  const updateTask = async ()=>{
    if(Data.title === "" || Data.desc === ""){
      ...
      await axios.put(`https://task-tracker-rkkb.onrender.com/api/task/update/${updatedData.id}`,Data,{headers})
      setUpdatedData({
        id: "",
        title: "",
        desc: "",
